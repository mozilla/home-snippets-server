# Django settings for homesnippets project.
import os
import sys
...
SECRET_KEY = 'r7c+&1i1^4%%znqw1!(izgk!rpbdsm+cj=ebjhuv6=um1sg7+1'
...
MIDDLEWARE_CLASSES = (
    ...
    'homesnippets.middleware.XFrameOptionsMiddleware',
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, "apps", "homesnippets", "templates"),
)
